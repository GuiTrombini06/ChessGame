...
public class IANivel3 implements IA {
    ...
    public Move makeMove(Game game) {
        ...
        for (Move move : allLegalMoves) {
            ...
            double score = minimax(gameCopy, maxDepth, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, !game.whiteToMove());
